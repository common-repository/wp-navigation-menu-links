...
Also, it supports the addition of [ProfilePress](https://profilepress.com/) edit profile form and front-end profile page links.
...
> If you own **[ProfilePress PRO](https://profilepress.com)** — a plugin that makes building custom login, registration, password reset, edit profile forms and front-end user profile stupidly simple — you can as well use this plugin to add its front-end profile and edit profile page links to WordPress menu.
>
...
>
> [Get ProfilePress PRO](https://profilepress.com/pricing/) or try the [Lite Version](https://wordpress.org/plugins/wp-user-avatar/).
...
Have any question, shoot us a mail via support[at]profilepress.com
